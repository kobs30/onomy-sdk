...
* (x/upgrade) [\#8673](https://github.com/onomyprotocol/onomy-sdk/pull/8673) Remove IBC logic from x/upgrade. Deprecates IBC fields in an Upgrade Plan. IBC upgrade logic moved to 02-client and an IBC UpgradeProposal is added.
...
* (simapp) [\#8418](https://github.com/onomyprotocol/onomy-sdk/pull/8418) Add balance coin to supply when adding a new genesis account
...
* __General__
  ...
  * (store) [\#6324](https://github.com/onomyprotocol/onomy-sdk/pull/6324) IAVL store query proofs now return CommitmentOp which wraps an ics23 CommitmentProof
...
* (types) [\#5447](https://github.com/onomyprotocol/onomy-sdk/pull/5447) Added `ApproxRoot` function to sdk.Decimal type in order to get the nth root for a decimal number, where n is a positive integer.
...
* (types) [\#5408](https://github.com/onomyprotocol/onomy-sdk/issues/5408) `NewDecCoins` constructor now sorts the coins.
...
* (ledger) [\#4716](https://github.com/onomyprotocol/onomy-sdk/pull/4716) Fix ledger custom coin type support bug.

### Bug Fixes

* (baseapp) [\#5200](https://github.com/onomyprotocol/onomy-sdk/issues/5200) Remove duplicate events from previous messages.

## [v0.37.3] - 2019-10-10

### Bug Fixes

* (genesis) [\#5095](https://github.com/onomyprotocol/onomy-sdk/issues/5095) Fix genesis file migration from v0.34 to
...
* (cli) [\#4973](https://github.com/onomyprotocol/onomy-sdk/pull/4973) Enable application CPU profiling
via the `--cpu-profile` flag.
* [\#4979](https://github.com/onomyprotocol/onomy-sdk/issues/4979) Introduce a new `halt-time` config and
CLI option to the `start` command. When provided, an application will halt during `Commit` when the
block time is >= the `halt-time`.

### Improvements

* [\#4990](https://github.com/onomyprotocol/onomy-sdk/issues/4990) Add `Events` to the `ABCIMessageLog` to
provide context and grouping of events based on the messages they correspond to. The `Events` field
in `TxResponse` is deprecated and will be removed in the next major release.

### Bug Fixes

* [\#4979](https://github.com/onomyprotocol/onomy-sdk/issues/4979) Use `Signal(os.Interrupt)` over
`os.Exit(0)` during configured halting to allow any `defer` calls to be executed.
* [\#5034](https://github.com/onomyprotocol/onomy-sdk/issues/5034) Binary search in NFT Module wasn't working on larger sets.

## [v0.37.0] - 2019-08-21

### Bug Fixes

* (baseapp) [\#4903](https://github.com/onomyprotocol/onomy-sdk/issues/4903) Various height query fixes:
  * Move height with proof check from `CLIContext` to `BaseApp` as the height
  can automatically be injected there.
  * Update `handleQueryStore` to resemble `handleQueryCustom`
* (simulation) [\#4912](https://github.com/onomyprotocol/onomy-sdk/issues/4912) Fix SimApp ModuleAccountAddrs
to properly return black listed addresses for bank keeper initialization.
* (cli) [\#4919](https://github.com/onomyprotocol/onomy-sdk/pull/4919) Don't crash CLI
if user doesn't answer y/n confirmation request.
* (cli) [\#4927](https://github.com/onomyprotocol/onomy-sdk/issues/4927) Fix the `q gov vote`
command to handle empty (pruned) votes correctly.

### Improvements

* (rest) [\#4924](https://github.com/onomyprotocol/onomy-sdk/pull/4924) Return response
...
* (rest) [\#4837](https://github.com/onomyprotocol/onomy-sdk/pull/4837) Remove /version and /node_version
  endpoints in favor of refactoring /node_info to also include application version info.
* All REST responses now wrap the original resource/result. The response
  will contain two fields: height and result.
* [\#3565](https://github.com/onomyprotocol/onomy-sdk/issues/3565) Updates to the governance module:
  * Rename JSON field from `proposal_content` to `content`
  * Rename JSON field from `proposal_id` to `id`
  * Disable `ProposalTypeSoftwareUpgrade` temporarily
* [\#3775](https://github.com/onomyprotocol/onomy-sdk/issues/3775) unify sender transaction tag for ease of querying
* [\#4255](https://github.com/onomyprotocol/onomy-sdk/issues/4255) Add supply module that passively tracks the supplies of a chain
  ...
  - [\#3628](https://github.com/onomyprotocol/onomy-sdk/issues/3628) Replaced governance's burn and deposit accounts for a `ModuleAccount`
...
* [\#4250](https://github.com/onomyprotocol/onomy-sdk/issues/4250) BaseApp.Query() returns app's version string set via BaseApp.SetAppVersion()
  when handling /app/version queries instead of the version string passed as build
  flag at compile time.
* [\#4262](https://github.com/onomyprotocol/onomy-sdk/issues/4262) GoSumHash is no longer returned by the version command.
* [\#4263](https://github.com/onomyprotocol/onomy-sdk/issues/4263) RestServer#Start now takes read and write timeout arguments.
* [\#4305](https://github.com/onomyprotocol/onomy-sdk/issues/4305) `GenerateOrBroadcastMsgs` no longer takes an `offline` parameter.
* [\#4342](https://github.com/onomyprotocol/onomy-sdk/pull/4342) Upgrade go-amino to v0.15.0
* [\#4351](https://github.com/onomyprotocol/onomy-sdk/issues/4351) InitCmd, AddGenesisAccountCmd, and CollectGenTxsCmd take node's and client's default home directories as arguments.
* [\#4387](https://github.com/onomyprotocol/onomy-sdk/issues/4387) Refactor the usage of tags (now called events) to reflect the
...
* [\#4437](https://github.com/onomyprotocol/onomy-sdk/issues/4437) Replace governance module store keys to use `[]byte` instead of `string`.
* [\#4451](https://github.com/onomyprotocol/onomy-sdk/issues/4451) Improve modularization of clients and modules:
  * Module directory structure improved and standardized
  * Aliases autogenerated
  * Auth and bank related commands are now mounted under the respective moduels
  * Client initialization and mounting standardized
* [\#4479](https://github.com/onomyprotocol/onomy-sdk/issues/4479) Remove codec argument redundency in client usage where
  the CLIContext's codec should be used instead.
* [\#4488](https://github.com/onomyprotocol/onomy-sdk/issues/4488) Decouple client tx, REST, and ultil packages from auth. These packages have
  been restructured and retrofitted into the `x/auth` module.
* [\#4521](https://github.com/onomyprotocol/onomy-sdk/issues/4521) Flatten x/bank structure by hiding module internals.
* [\#4525](https://github.com/onomyprotocol/onomy-sdk/issues/4525) Remove --cors flag, the feature is long gone.
* [\#4536](https://github.com/onomyprotocol/onomy-sdk/issues/4536) The `/auth/accounts/{address}` now returns a `height` in the response.
  The account is now nested under `account`.
* [\#4543](https://github.com/onomyprotocol/onomy-sdk/issues/4543) Account getters are no longer part of client.CLIContext() and have now moved
  to reside in the auth-specific AccountRetriever.
* [\#4588](https://github.com/onomyprotocol/onomy-sdk/issues/4588) Context does not depend on x/auth anymore. client/context is stripped out of the following features:
  - GetAccountDecoder()
  - CLIContext.WithAccountDecoder()
  - CLIContext.WithAccountStore()
  x/auth.AccountDecoder is unnecessary and consequently removed.
* [\#4602](https://github.com/onomyprotocol/onomy-sdk/issues/4602) client/input.{Buffer,Override}Stdin() functions are removed. Thanks to cobra's new release they are now redundant.
* [\#4633](https://github.com/onomyprotocol/onomy-sdk/issues/4633) Update old Tx search by tags APIs to use new Events
  nomenclature.
* [\#4649](https://github.com/onomyprotocol/onomy-sdk/issues/4649) Refactor x/crisis as per modules new specs.
* [\#3685](https://github.com/onomyprotocol/onomy-sdk/issues/3685) The default signature verification gas logic (`DefaultSigVerificationGasConsumer`) now specifies explicit key types rather than string pattern matching. This means that zones that depended on string matching to allow other keys will need to write a custom `SignatureVerificationGasConsumer` function.
* [\#4663](https://github.com/onomyprotocol/onomy-sdk/issues/4663) Refactor bank keeper by removing private functions
  - `InputOutputCoins`, `SetCoins`, `SubtractCoins` and `AddCoins` are now part of the `SendKeeper` instead of the `Keeper` interface
* (tendermint) [\#4721](https://github.com/onomyprotocol/onomy-sdk/pull/4721) Upgrade Tendermint to v0.32.1

### Features

* [\#4843](https://github.com/onomyprotocol/onomy-sdk/issues/4843) Add RegisterEvidences function in the codec package to register
  Tendermint evidence types with a given codec.
* (rest) [\#3867](https://github.com/onomyprotocol/onomy-sdk/issues/3867) Allow querying for genesis transaction when height query param is set to zero.
* [\#2020](https://github.com/onomyprotocol/onomy-sdk/issues/2020) New keys export/import command line utilities to export/import private keys in ASCII format
  that rely on Keybase's new underlying ExportPrivKey()/ImportPrivKey() API calls.
* [\#3565](https://github.com/onomyprotocol/onomy-sdk/issues/3565) Implement parameter change proposal support.
  Parameter change proposals can be submitted through the CLI
  or a REST endpoint. See docs for further usage.
* [\#3850](https://github.com/onomyprotocol/onomy-sdk/issues/3850) Add `rewards` and `commission` to distribution tx tags.
* [\#3981](https://github.com/onomyprotocol/onomy-sdk/issues/3981) Add support to gracefully halt a node at a given height
  via the node's `halt-height` config or CLI value.
* [\#4144](https://github.com/onomyprotocol/onomy-sdk/issues/4144) Allow for configurable BIP44 HD path and coin type.
* [\#4250](https://github.com/onomyprotocol/onomy-sdk/issues/4250) New BaseApp.{,Set}AppVersion() methods to get/set app's version string.
* [\#4263](https://github.com/onomyprotocol/onomy-sdk/issues/4263) Add `--read-timeout` and `--write-timeout` args to the `rest-server` command
  to support custom RPC R/W timeouts.
* [\#4271](https://github.com/onomyprotocol/onomy-sdk/issues/4271) Implement Coins#IsAnyGT
* [\#4318](https://github.com/onomyprotocol/onomy-sdk/issues/4318) Support height queries. Queries against nodes that have the queried
  height pruned will return an error.
* [\#4409](https://github.com/onomyprotocol/onomy-sdk/issues/4409) Implement a command that migrates exported state from one version to the next.
  The `migrate` command currently supports migrating from v0.34 to v0.36 by implementing
  necessary types for both versions.
* [\#4570](https://github.com/onomyprotocol/onomy-sdk/issues/4570) Move /bank/balances/{address} REST handler to x/bank/client/rest. The exposed interface is unchanged.
* Community pool spend proposal per Cosmos Hub governance proposal [\#7](https://github.com/onomyprotocol/onomy-sdk/issues/7) "Activate the Community Pool"

### Improvements

* (simulation) PrintAllInvariants flag will print all failed invariants
* (simulation) Add `InitialBlockHeight` flag to resume a simulation from a given block
* (simulation) [\#4670](https://github.com/onomyprotocol/onomy-sdk/issues/4670) Update simulation statistics to JSON format

  - Support exporting the simulation stats to a given JSON file
* [\#4775](https://github.com/onomyprotocol/onomy-sdk/issues/4775) Refactor CI config
* Upgrade IAVL to v0.12.4
* (tendermint) Upgrade Tendermint to v0.32.2
* (modules) [\#4751](https://github.com/onomyprotocol/onomy-sdk/issues/4751) update `x/genutils` to match module spec
* (keys) [\#4611](https://github.com/onomyprotocol/onomy-sdk/issues/4611) store keys in simapp now use a map instead of using individual literal keys
* [\#2286](https://github.com/onomyprotocol/onomy-sdk/issues/2286) Improve performance of CacheKVStore iterator.
* [\#3512](https://github.com/onomyprotocol/onomy-sdk/issues/3512) Implement Logger method on each module's keeper.
* [\#3655](https://github.com/onomyprotocol/onomy-sdk/issues/3655) Improve signature verification failure error message.
* [\#3774](https://github.com/onomyprotocol/onomy-sdk/issues/3774) add category tag to transactions for ease of filtering
* [\#3914](https://github.com/onomyprotocol/onomy-sdk/issues/3914) Implement invariant benchmarks and add target to makefile.
* [\#3928](https://github.com/onomyprotocol/onomy-sdk/issues/3928) remove staking references from types package
* [\#3978](https://github.com/onomyprotocol/onomy-sdk/issues/3978) Return ErrUnknownRequest in message handlers for unknown
  or invalid routed messages.
* [\#4190](https://github.com/onomyprotocol/onomy-sdk/issues/4190) Client responses that return (re)delegation(s) now return balances
  instead of shares.
* [\#4194](https://github.com/onomyprotocol/onomy-sdk/issues/4194) ValidatorSigningInfo now includes the validator's consensus address.
* [\#4235](https://github.com/onomyprotocol/onomy-sdk/issues/4235) Add parameter change proposal messages to simulation.
* [\#4235](https://github.com/onomyprotocol/onomy-sdk/issues/4235) Update the minting module params to implement params.ParamSet so
  individual keys can be set via proposals instead of passing a struct.
* [\#4259](https://github.com/onomyprotocol/onomy-sdk/issues/4259) `Coins` that are `nil` are now JSON encoded as an empty array `[]`.
  Decoding remains unchanged and behavior is left intact.
* [\#4305](https://github.com/onomyprotocol/onomy-sdk/issues/4305) The `--generate-only` CLI flag fully respects offline tx processing.
* [\#4379](https://github.com/onomyprotocol/onomy-sdk/issues/4379) close db write batch.
* [\#4384](https://github.com/onomyprotocol/onomy-sdk/issues/4384)- Allow splitting withdrawal transaction in several chunks
* [\#4403](https://github.com/onomyprotocol/onomy-sdk/issues/4403) Allow for parameter change proposals to supply only desired fields to be updated
  in objects instead of the entire object (only applies to values that are objects).
* [\#4415](https://github.com/onomyprotocol/onomy-sdk/issues/4415) /client refactor, reduce genutil dependancy on staking
* [\#4439](https://github.com/onomyprotocol/onomy-sdk/issues/4439) Implement governance module iterators.
* [\#4465](https://github.com/onomyprotocol/onomy-sdk/issues/4465) Unknown subcommands print relevant error message
* [\#4466](https://github.com/onomyprotocol/onomy-sdk/issues/4466) Commission validation added to validate basic of MsgCreateValidator by changing CommissionMsg to CommissionRates
* [\#4501](https://github.com/onomyprotocol/onomy-sdk/issues/4501) Support height queriers in rest client
* [\#4535](https://github.com/onomyprotocol/onomy-sdk/issues/4535) Improve import-export simulation errors by decoding the `KVPair.Value` into its
  respective type
* [\#4536](https://github.com/onomyprotocol/onomy-sdk/issues/4536) cli context queries return query height and accounts are returned with query height
* [\#4553](https://github.com/onomyprotocol/onomy-sdk/issues/4553) undelegate max entries check first
* [\#4556](https://github.com/onomyprotocol/onomy-sdk/issues/4556) Added IsValid function to Coin
* [\#4564](https://github.com/onomyprotocol/onomy-sdk/issues/4564) client/input.GetConfirmation()'s default is changed to No.
* [\#4573](https://github.com/onomyprotocol/onomy-sdk/issues/4573) Returns height in response for query endpoints.
* [\#4580](https://github.com/onomyprotocol/onomy-sdk/issues/4580) Update `Context#BlockHeight` to properly set the block height via `WithBlockHeader`.
* [\#4584](https://github.com/onomyprotocol/onomy-sdk/issues/4584) Update bank Keeper to use expected keeper interface of the AccountKeeper.
* [\#4584](https://github.com/onomyprotocol/onomy-sdk/issues/4584) Move `Account` and `VestingAccount` interface types to `x/auth/exported`.
* [\#4082](https://github.com/onomyprotocol/onomy-sdk/issues/4082) supply module queriers for CLI and REST endpoints
* [\#4601](https://github.com/onomyprotocol/onomy-sdk/issues/4601) Implement generic pangination helper function to be used in
  REST handlers and queriers.
* [\#4629](https://github.com/onomyprotocol/onomy-sdk/issues/4629) Added warning event that gets emitted if validator misses a block.
* [\#4674](https://github.com/onomyprotocol/onomy-sdk/issues/4674) Export `Simapp` genState generators and util functions by making them public
* [\#4706](https://github.com/onomyprotocol/onomy-sdk/issues/4706) Simplify context
...
* [\#3685](https://github.com/onomyprotocol/onomy-sdk/issues/3685)  Add `SetAddressVerifier` and `GetAddressVerifier` to `sdk.Config` to allow SDK users to configure custom address format verification logic (to override the default limitation of 20-byte addresses).
* [\#3685](https://github.com/onomyprotocol/onomy-sdk/issues/3685)  Add an additional parameter to NewAnteHandler for a custom `SignatureVerificationGasConsumer` (the default logic is now in `DefaultSigVerificationGasConsumer). This allows SDK users to configure their own logic for which key types are accepted and how those key types consume gas.
* Remove `--print-response` flag as it is no longer used.
* Revert [\#2284](https://github.com/onomyprotocol/onomy-sdk/pull/2284) to allow create_empty_blocks in the config
* (tendermint) [\#4718](https://github.com/onomyprotocol/onomy-sdk/issues/4718) Upgrade tendermint/iavl to v0.12.3

### Bug Fixes

* [\#4891](https://github.com/onomyprotocol/onomy-sdk/issues/4891) Disable querying with proofs enabled when the query height <= 1.
* (rest) [\#4858](https://github.com/onomyprotocol/onomy-sdk/issues/4858) Do not return an error in BroadcastTxCommit when the tx broadcasting
  was successful. This allows the proper REST response to be returned for a
  failed tx during `block` broadcasting mode.
* (store) [\#4880](https://github.com/onomyprotocol/onomy-sdk/pull/4880) Fix error check in
  IAVL `Store#DeleteVersion`.
* (tendermint) [\#4879](https://github.com/onomyprotocol/onomy-sdk/issues/4879) Don't terminate the process immediately after startup when run in standalone mode.
* (simulation) [\#4861](https://github.com/onomyprotocol/onomy-sdk/pull/4861) Fix non-determinism simulation
  by using CLI flags as input and updating Makefile target.
* [\#4868](https://github.com/onomyprotocol/onomy-sdk/issues/4868) Context#CacheContext now sets a new EventManager. This prevents unwanted events
  from being emitted.
* (cli) [\#4870](https://github.com/onomyprotocol/onomy-sdk/issues/4870) Disable the `withdraw-all-rewards` command when `--generate-only` is supplied
* (modules) [\#4831](https://github.com/onomyprotocol/onomy-sdk/issues/4831) Prevent community spend proposal from transferring funds to a module account
* (keys) [\#4338](https://github.com/onomyprotocol/onomy-sdk/issues/4338) fix multisig key output for CLI
* (modules) [\#4795](https://github.com/onomyprotocol/onomy-sdk/issues/4795) restrict module accounts from receiving transactions.
  Allowing this would cause an invariant on the module account coins.
* (modules) [\#4823](https://github.com/onomyprotocol/onomy-sdk/issues/4823) Update the `DefaultUnbondingTime` from 3 days to 3 weeks to be inline with documentation.
* (abci) [\#4639](https://github.com/onomyprotocol/onomy-sdk/issues/4639) Fix `CheckTx` by verifying the message route
* Return height in responses when querying against BaseApp
* [\#1351](https://github.com/onomyprotocol/onomy-sdk/issues/1351) Stable AppHash allows no_empty_blocks
* [\#3705](https://github.com/onomyprotocol/onomy-sdk/issues/3705) Return `[]` instead of `null` when querying delegator rewards.
* [\#3966](https://github.com/onomyprotocol/onomy-sdk/issues/3966) fixed multiple assigns to action tags
  [\#3793](https://github.com/onomyprotocol/onomy-sdk/issues/3793) add delegator tag for MsgCreateValidator and deleted unused moniker and identity tags
* [\#4194](https://github.com/onomyprotocol/onomy-sdk/issues/4194) Fix pagination and results returned from /slashing/signing_infos
* [\#4230](https://github.com/onomyprotocol/onomy-sdk/issues/4230) Properly set and display the message index through the TxResponse.
* [\#4234](https://github.com/onomyprotocol/onomy-sdk/pull/4234) Allow `tx send --generate-only` to
  actually work offline.
* [\#4271](https://github.com/onomyprotocol/onomy-sdk/issues/4271) Fix addGenesisAccount by using Coins#IsAnyGT for vesting amount validation.
* [\#4273](https://github.com/onomyprotocol/onomy-sdk/issues/4273) Fix usage of AppendTags in x/staking/handler.go
* [\#4303](https://github.com/onomyprotocol/onomy-sdk/issues/4303) Fix NewCoins() underlying function for duplicate coins detection.
* [\#4307](https://github.com/onomyprotocol/onomy-sdk/pull/4307) Don't pass height to RPC calls as
  Tendermint will automatically use the latest height.
* [\#4362](https://github.com/onomyprotocol/onomy-sdk/issues/4362) simulation setup bugfix for multisim 7601778
* [\#4383](https://github.com/onomyprotocol/onomy-sdk/issues/4383) - currentStakeRoundUp is now always atleast currentStake + smallest-decimal-precision
* [\#4394](https://github.com/onomyprotocol/onomy-sdk/issues/4394) Fix signature count check to use the TxSigLimit param instead of
  a default.
* [\#4455](https://github.com/onomyprotocol/onomy-sdk/issues/4455) Use `QueryWithData()` to query unbonding delegations.
* [\#4493](https://github.com/onomyprotocol/onomy-sdk/issues/4493) Fix validator-outstanding-rewards command. It now takes as an argument
  a validator address.
* [\#4598](https://github.com/onomyprotocol/onomy-sdk/issues/4598) Fix redelegation and undelegation txs that were not checking for the correct bond denomination.
* [\#4619](https://github.com/onomyprotocol/onomy-sdk/issues/4619) Close iterators in `GetAllMatureValidatorQueue` and `UnbondAllMatureValidatorQueue`
  methods.
* [\#4654](https://github.com/onomyprotocol/onomy-sdk/issues/4654) validator slash event stored by period and height
* [\#4681](https://github.com/onomyprotocol/onomy-sdk/issues/4681) panic on invalid amount on `MintCoins` and `BurnCoins`
...
* [\#4135](https://github.com/onomyprotocol/onomy-sdk/pull/4135) Add further clarification
...
* [\#3245](https://github.com/onomyprotocol/onomy-sdk/issues/3245) Rename validator.GetJailed() to validator.IsJailed()
* [\#3516](https://github.com/onomyprotocol/onomy-sdk/issues/3516) Remove concept of shares from staking unbonding and redelegation UX;
  replaced by direct coin amount.

#### Tendermint

* [\#4029](https://github.com/onomyprotocol/onomy-sdk/issues/4029) Upgrade Tendermint to v0.31.3

### New features

#### SDK

* [\#2935](https://github.com/onomyprotocol/onomy-sdk/issues/2935) New module Crisis which can test broken invariant with messages
* [\#3813](https://github.com/onomyprotocol/onomy-sdk/issues/3813) New sdk.NewCoins safe constructor to replace bare sdk.Coins{} declarations.
...
* [\#3238](https://github.com/onomyprotocol/onomy-sdk/issues/3238) Add block time to tx responses when querying for
  txs by tags or hash.
* \[\#3752](https://github.com/onomyprotocol/onomy-sdk/issues/3752) Explanatory docs for minting mechanism (`docs/spec/mint/01_concepts.md`)
* [\#3801](https://github.com/onomyprotocol/onomy-sdk/issues/3801) `baseapp` safety improvements
* [\#3820](https://github.com/onomyprotocol/onomy-sdk/issues/3820) Make Coins.IsAllGT() more robust and consistent.
* [\#3828](https://github.com/onomyprotocol/onomy-sdk/issues/3828) New sdkch tool to maintain changelogs
* [\#3864](https://github.com/onomyprotocol/onomy-sdk/issues/3864) Make Coins.IsAllGTE() more consistent.
* [\#3907](https://github.com/onomyprotocol/onomy-sdk/issues/3907): dep -> go mod migration
  * Drop dep in favor of go modules.
  * Upgrade to Go 1.12.1.
* [\#3917](https://github.com/onomyprotocol/onomy-sdk/issues/3917) Allow arbitrary decreases to validator commission rates.
* [\#3937](https://github.com/onomyprotocol/onomy-sdk/issues/3937) Implement community pool querier.
* [\#3940](https://github.com/onomyprotocol/onomy-sdk/issues/3940) Codespace should be lowercase.
* [\#3986](https://github.com/onomyprotocol/onomy-sdk/issues/3986) Update the Stringer implementation of the Proposal type.
* [\#926](https://github.com/onomyprotocol/onomy-sdk/issues/926) circuit breaker high level explanation
* [\#3896](https://github.com/onomyprotocol/onomy-sdk/issues/3896) Fixed various linters warnings in the context of the gometalinter -> golangci-lint migration
* [\#3916](https://github.com/onomyprotocol/onomy-sdk/issues/3916) Hex encode data in tx responses
...
* [\#3837](https://github.com/onomyprotocol/onomy-sdk/issues/3837) Fix `WithdrawValidatorCommission` to properly set the validator's remaining commission.
* [\#3870](https://github.com/onomyprotocol/onomy-sdk/issues/3870) Fix DecCoins#TruncateDecimal to never return zero coins in
  either the truncated coins or the change coins.
* [\#3915](https://github.com/onomyprotocol/onomy-sdk/issues/3915) Remove ';' delimiting support from ParseDecCoins
* [\#3977](https://github.com/onomyprotocol/onomy-sdk/issues/3977) Fix docker image build
* [\#4020](https://github.com/onomyprotocol/onomy-sdk/issues/4020) Fix queryDelegationRewards by returning an error
when the validator or delegation do not exist.
* [\#4050](https://github.com/onomyprotocol/onomy-sdk/issues/4050) Fix DecCoins APIs
where rounding or truncation could result in zero decimal coins.
* [\#4088](https://github.com/onomyprotocol/onomy-sdk/issues/4088) Fix `calculateDelegationRewards`
...
* Gaia REST API
  ...
  * [\#3692](https://github.com/onomyprotocol/onomy-sdk/pull/3692) Update tx encoding and broadcasting endpoints:
...
* Gaia
  ...
  * [\#3789](https://github.com/onomyprotocol/onomy-sdk/pull/3789) Update validator creation flow:
    * Remove `NewMsgCreateValidatorOnBehalfOf` and corresponding business logic
    * Ensure the validator address equals the delegator address during
    `MsgCreateValidator#ValidateBasic`

* SDK
  * [\#3750](https://github.com/onomyprotocol/onomy-sdk/issues/3750) Track outstanding rewards per-validator instead of globally,
  ...
  * [\#3669](https://github.com/onomyprotocol/onomy-sdk/pull/3669) Ensure consistency in message naming, codec registration, and JSON
  tags.
  * [\#3788](https://github.com/onomyprotocol/onomy-sdk/pull/3788) Change order of operations for greater accuracy when calculating delegation share token value
  * [\#3788](https://github.com/onomyprotocol/onomy-sdk/pull/3788) DecCoins.Cap -> DecCoins.Intersect
  * [\#3666](https://github.com/onomyprotocol/onomy-sdk/pull/3666) Improve coins denom validation.
  * [\#3751](https://github.com/onomyprotocol/onomy-sdk/pull/3751) Disable (temporarily) support for ED25519 account key pairs.
...
* SDK
  * [\#3719](https://github.com/onomyprotocol/onomy-sdk/issues/3719) DBBackend can now be set at compile time.
...
* SDK
  * [\#3753](https://github.com/onomyprotocol/onomy-sdk/issues/3753) Remove no-longer-used governance penalty parameter
  * [\#3679](https://github.com/onomyprotocol/onomy-sdk/issues/3679) Consistent operators across Coins, DecCoins, Int, Dec
            replaced: Minus->Sub Plus->Add Div->Quo
  * [\#3665](https://github.com/onomyprotocol/onomy-sdk/pull/3665) Overhaul sdk.Uint type in preparation for Coins Int -> Uint migration.
  * [\#3691](https://github.com/onomyprotocol/onomy-sdk/issues/3691) Cleanup error messages
  * [\#3456](https://github.com/onomyprotocol/onomy-sdk/issues/3456) Integrate in the Int.ToDec() convenience function
  * [\#3300](https://github.com/onomyprotocol/onomy-sdk/pull/3300) Update the spec-spec, spec file reorg, and TOC updates.
  * [\#3694](https://github.com/onomyprotocol/onomy-sdk/pull/3694) Push tagged docker images on docker hub when tag is created.
  * [\#3716](https://github.com/onomyprotocol/onomy-sdk/pull/3716) Update file permissions the client keys directory and contents to `0700`.
  * [\#3681](https://github.com/onomyprotocol/onomy-sdk/issues/3681) Migrate ledger-cosmos-go from ZondaX to Cosmos organization

* Tendermint
  * [\#3699](https://github.com/onomyprotocol/onomy-sdk/pull/3699) Upgrade to Tendermint 0.30.1
...
* SDK
  * [\#3728](https://github.com/onomyprotocol/onomy-sdk/issues/3728) Truncate decimal multiplication & division in distribution to ensure
           no more than the collected fees / inflation are distributed
  * [\#3727](https://github.com/onomyprotocol/onomy-sdk/issues/3727) Return on zero-length (including []byte{}) PrefixEndBytes() calls
  * [\#3559](https://github.com/onomyprotocol/onomy-sdk/issues/3559) fix occasional failing due to non-determinism in lcd test TestBonding
    where validator is unexpectedly slashed throwing off test calculations
  * [\#3411](https://github.com/onomyprotocol/onomy-sdk/pull/3411) Include the `RequestInitChain.Time` in the block header init during
  `InitChain`.
  * [\#3717](https://github.com/onomyprotocol/onomy-sdk/pull/3717) Update the vesting specification and implementation to cap deduction from
  `DelegatedVesting` by at most `DelegatedVesting`. This accounts for the case where
  the undelegation amount may exceed the original delegation amount due to
  truncation of undelegation tokens.
  * [\#3717](https://github.com/onomyprotocol/onomy-sdk/pull/3717) Ignore unknown proposers in allocating rewards for proposers, in case
    unbonding period was just 1 block and proposer was already deleted.
  * [\#3726](https://github.com/onomyprotocol/onomy-sdk/pull/3724) Cap(clip) reward to remaining coins in AllocateTokens.
...
* SDK
 * [\#3580](https://github.com/onomyprotocol/onomy-sdk/issues/3580) Migrate HTTP request/response types and utilities to types/rest.
 * [\#3592](https://github.com/onomyprotocol/onomy-sdk/issues/3592) Drop deprecated keybase implementation's New() constructor in
   favor of a new crypto/keys.New(string, string) implementation that
   returns a lazy keybase instance. Remove client.MockKeyBase,
   superseded by crypto/keys.NewInMemory()
 * [\#3621](https://github.com/onomyprotocol/onomy-sdk/issues/3621) staking.GenesisState.Bonds -> Delegations

IMPROVEMENTS

* SDK
  * [\#3311](https://github.com/onomyprotocol/onomy-sdk/pull/3311) Reconcile the `DecCoin/s` API with the `Coin/s` API.
  * [\#3614](https://github.com/onomyprotocol/onomy-sdk/pull/3614) Add coin denom length checks to the coins constructors.
  * [\#3621](https://github.com/onomyprotocol/onomy-sdk/issues/3621) remove many inter-module dependancies
  * [\#3601](https://github.com/onomyprotocol/onomy-sdk/pull/3601) JSON-stringify the ABCI log response which includes the log and message
  index.
  * [\#3604](https://github.com/onomyprotocol/onomy-sdk/pull/3604) Improve SDK funds related error messages and allow for unicode in
  JSON ABCI log.
  * [\#3620](https://github.com/onomyprotocol/onomy-sdk/pull/3620) Version command shows build tags
  * [\#3638](https://github.com/onomyprotocol/onomy-sdk/pull/3638) Add Bcrypt benchmarks & justification of security parameter choice
  * [\#3648](https://github.com/onomyprotocol/onomy-sdk/pull/3648) Add JSON struct tags to vesting accounts.

* Tendermint
  * [\#3618](https://github.com/onomyprotocol/onomy-sdk/pull/3618) Upgrade to Tendermint 0.30.03

BUG FIXES

* SDK
  * [\#3646](https://github.com/onomyprotocol/onomy-sdk/issues/3646) `x/mint` now uses total token supply instead of total bonded tokens to calculate inflation
...
* SDK
 * [\#3592](https://github.com/onomyprotocol/onomy-sdk/issues/3592) Drop deprecated keybase implementation's
...
* SDK
  * [\#3604](https://github.com/onomyprotocol/onomy-sdk/pulls/3604) Improve SDK funds related error messages and allow for unicode in
  JSON ABCI log.

* Tendermint
  * [\#3563](https://github.com/onomyprotocol/onomy-sdk/3563) Update to Tendermint version `0.30.0-rc0`
...
* SDK
  * [\#3582](https://github.com/onomyprotocol/onomy-sdk/pull/3582) Running `make test_unit` was failing due to a missing tag
  * [\#3617](https://github.com/onomyprotocol/onomy-sdk/pull/3582) Fix fee comparison when the required fees does not contain any denom
...
* SDK
  * [\#2513](https://github.com/onomyprotocol/onomy-sdk/issues/2513) Tendermint updates are adjusted by 10^-6 relative to staking tokens,
  * [\#3487](https://github.com/onomyprotocol/onomy-sdk/pull/3487) Move HTTP/REST utilities out of client/utils into a new dedicated client/rest package.
  * [\#3490](https://github.com/onomyprotocol/onomy-sdk/issues/3490) ReadRESTReq() returns bool to avoid callers to write error responses twice.
  * [\#3502](https://github.com/onomyprotocol/onomy-sdk/pull/3502) Fixes issue when comparing genesis states
  * [\#3514](https://github.com/onomyprotocol/onomy-sdk/pull/3514) Various clean ups:
    - Replace all GetKeyBase\* functions family in favor of NewKeyBaseFromDir and NewKeyBaseFromHomeFlag.
    - Remove Get prefix from all TxBuilder's getters.
  * [\#3522](https://github.com/onomyprotocol/onomy-sdk/pull/3522) Get rid of double negatives: Coins.IsNotNegative() -> Coins.IsAnyNegative().
  * [\#3561](https://github.com/onomyprotocol/onomy-sdk/issues/3561) Don't unnecessarily store denominations in staking
...
* SDK
  * [\#3270](https://github.com/onomyprotocol/onomy-sdk/issues/3270) [x/staking] limit number of ongoing unbonding delegations /redelegations per pair/trio
  * [\#3477][distribution] new query endpoint "delegator_validators"
  * [\#3514](https://github.com/onomyprotocol/onomy-sdk/pull/3514) Provided a lazy loading implementation of Keybase that locks the underlying
    storage only for the time needed to perform the required operation. Also added Keybase reference to TxBuilder struct.
  * [types] [\#2580](https://github.com/onomyprotocol/onomy-sdk/issues/2580) Addresses now Bech32 empty addresses to an empty string
...
* Gaia REST API
  ...
  * [\#3423](https://github.com/onomyprotocol/onomy-sdk/issues/3423) Allow simulation
...
* SDK
  ...
  * [\#2986](https://github.com/onomyprotocol/onomy-sdk/pull/2986) Store Refactor
  * [\#3435](https://github.com/onomyprotocol/onomy-sdk/issues/3435) Test that store implementations do not allow nil values
  * [\#2509](https://github.com/onomyprotocol/onomy-sdk/issues/2509) Sanitize all usage of Dec.RoundInt64()
  * [\#556](https://github.com/onomyprotocol/onomy-sdk/issues/556) Increase `BaseApp`
  test coverage.
  * [\#3357](https://github.com/onomyprotocol/onomy-sdk/issues/3357) develop state-transitions.md for staking spec, missing states added to `state.md`
  * [\#3552](https://github.com/onomyprotocol/onomy-sdk/pull/3552) Validate bit length when
...
* SDK
  * [distribution] [\#3359](https://github.com/onomyprotocol/onomy-sdk/issues/3359) Always round down when calculating rewards-to-be-withdrawn in F1 fee distribution
  * [#3336](https://github.com/onomyprotocol/onomy-sdk/issues/3336) Ensure all SDK
  messages have their signature bytes contain canonical fields `value` and `type`.
  * [\#3333](https://github.com/onomyprotocol/onomy-sdk/issues/3333) - F1 storage efficiency improvements - automatic withdrawals when unbonded, historical reward reference counting
  * [staking] [\#2513](https://github.com/onomyprotocol/onomy-sdk/issues/2513) Validator power type from Dec -> Int
  * [staking] [\#3233](https://github.com/onomyprotocol/onomy-sdk/issues/3233) key and value now contain duplicate fields to simplify code
  * [\#3064](https://github.com/onomyprotocol/onomy-sdk/issues/3064) Sanitize `sdk.Coin` denom. Coins denoms are now case insensitive, i.e. 100fooToken equals to 100FOOTOKEN.
  * [\#3195](https://github.com/onomyprotocol/onomy-sdk/issues/3195) Allows custom configuration for syncable strategy
  * [\#3242](https://github.com/onomyprotocol/onomy-sdk/issues/3242) Fix infinite gas
    meter utilization during aborted ante handler executions.
  * [x/distribution] [\#3292](https://github.com/onomyprotocol/onomy-sdk/issues/3292) Enable or disable withdraw addresses with a parameter in the param store
  * [staking] [\#2222](https://github.com/onomyprotocol/onomy-sdk/issues/2222) `/stake` -> `/staking` module rename
  * [staking] [\#1268](https://github.com/onomyprotocol/onomy-sdk/issues/1268) `LooseTokens` -> `NotBondedTokens`
  * [staking] [\#1402](https://github.com/onomyprotocol/onomy-sdk/issues/1402) Redelegation and unbonding-delegation structs changed to include multiple an array of entries
  * [staking] [\#3289](https://github.com/onomyprotocol/onomy-sdk/issues/3289) misc renames:
    * `Validator.UnbondingMinTime` -> `Validator.UnbondingCompletionTime`
    * `Delegation` -> `Value` in `MsgCreateValidator` and `MsgDelegate`
    * `MsgBeginUnbonding` -> `MsgUndelegate`
  * [\#3315] Increase decimal precision to 18
  * [\#3323](https://github.com/onomyprotocol/onomy-sdk/issues/3323) Update to Tendermint 0.29.0
  * [\#3328](https://github.com/onomyprotocol/onomy-sdk/issues/3328) [x/gov] Remove redundant action tag

* Tendermint
  * [\#3298](https://github.com/onomyprotocol/onomy-sdk/issues/3298) Upgrade to Tendermint 0.28.0
...
* Gaia
  ...
  * [\#3198](https://github.com/onomyprotocol/onomy-sdk/issues/3198) [x/auth] Add multisig transactions support
  * [\#3198](https://github.com/onomyprotocol/onomy-sdk/issues/3198) `add-genesis-account` can take both account addresses and key names

* SDK
  - [\#3099](https://github.com/onomyprotocol/onomy-sdk/issues/3099) Implement F1 fee distribution
  - [\#2926](https://github.com/onomyprotocol/onomy-sdk/issues/2926) Add TxEncoder to client TxBuilder.
  * [\#2694](https://github.com/onomyprotocol/onomy-sdk/issues/2694) Vesting account implementation.
  * [\#2996](https://github.com/onomyprotocol/onomy-sdk/issues/2996) Update the `AccountKeeper` to contain params used in the context of
  the ante handler.
  * [\#3179](https://github.com/onomyprotocol/onomy-sdk/pull/3179) New CodeNoSignatures error code.
  * [\#3319](https://github.com/onomyprotocol/onomy-sdk/issues/3319) [x/distribution] Queriers for all distribution state worth querying; distribution query commands
  * [\#3356](https://github.com/onomyprotocol/onomy-sdk/issues/3356) [x/auth] bech32-ify accounts address in error message.
...
* Gaia
  ...
  * [\#3250](https://github.com/onomyprotocol/onomy-sdk/pull/3250) Refactor integration tests and increase coverage
  * [\#3248](https://github.com/onomyprotocol/onomy-sdk/issues/3248) Refactor tx fee
  model:
...
* SDK
  * [\#3137](https://github.com/onomyprotocol/onomy-sdk/pull/3137) Add tag documentation
    for each module along with cleaning up a few existing tags in the governance,
    slashing, and staking modules.
  * [\#3093](https://github.com/onomyprotocol/onomy-sdk/issues/3093) Ante handler does no longer read all accounts in one go when processing signatures as signature
    verification may fail before last signature is checked.
  * [staking] [\#1402](https://github.com/onomyprotocol/onomy-sdk/issues/1402) Add for multiple simultaneous redelegations or unbonding-delegations within an unbonding period
  * [staking] [\#1268](https://github.com/onomyprotocol/onomy-sdk/issues/1268) staking spec rewrite

* CI
  * [\#2498](https://github.com/onomyprotocol/onomy-sdk/issues/2498) Added macos CI job to CircleCI
...
* SDK
  * [\#3207](https://github.com/onomyprotocol/onomy-sdk/issues/3207) - Fix token printing bug
...
* SDK
  * [auth] [\#2952](https://github.com/onomyprotocol/onomy-sdk/issues/2952) Signatures are no longer serialized on chain with the account number and sequence number
  * [auth] [\#2952](https://github.com/onomyprotocol/onomy-sdk/issues/2952) Signatures are no longer serialized on chain with the account number and sequence number
  * [stake] [\#3055](https://github.com/onomyprotocol/onomy-sdk/issues/3055) Use address instead of bond height / intratxcounter for deduplication
...
* SDK
  ...
  * [\#2963](https://github.com/onomyprotocol/onomy-sdk/issues/2963) Complete auth module specification
  * [\#2914](https://github.com/onomyprotocol/onomy-sdk/issues/2914) No longer withdraw validator rewards on bond/unbond, but rather move
...
* SDK
  * [\#2967](https://github.com/onomyprotocol/onomy-sdk/issues/2967) Change ordering of `mint.BeginBlocker` and `distr.BeginBlocker`, recalculate inflation each block
  * [\#3068](https://github.com/onomyprotocol/onomy-sdk/issues/3068) check for uint64 gas overflow during `Std#ValidateBasic`.
  * [\#3071](https://github.com/onomyprotocol/onomy-sdk/issues/3071) Catch overflow on block gas meter
...
* SDK
  * [\#2752](https://github.com/onomyprotocol/onomy-sdk/pull/2752) Don't hardcode bondable denom.
  * [\#2701](https://github.com/onomyprotocol/onomy-sdk/issues/2701) Account numbers and sequence numbers in `auth` are now `uint64` instead of `int64`
  * [\#2019](https://github.com/onomyprotocol/onomy-sdk/issues/2019) Cap total number of signatures. Current per-transaction limit is 7, and if that is exceeded transaction is rejected.
  * [\#2801](https://github.com/onomyprotocol/onomy-sdk/pull/2801) Remove AppInit structure.
  * [\#2798](https://github.com/onomyprotocol/onomy-sdk/issues/2798) Governance API has miss-spelled English word in JSON response ('depositer' -> 'depositor')
  * [\#2943](https://github.com/onomyprotocol/onomy-sdk/pull/2943) Transaction action tags equal the message type. Staking EndBlocker tags are included.
...
* SDK
  * [simulator] [\#2682](https://github.com/onomyprotocol/onomy-sdk/issues/2682) MsgEditValidator now looks at the validator's max rate, thus it now succeeds a significant portion of the time
  * [core] [\#2775](https://github.com/onomyprotocol/onomy-sdk/issues/2775) Add deliverTx maximum block gas limit
 ...
 * [\#2821](https://github.com/onomyprotocol/onomy-sdk/issues/2821) Codespaces are now strings
 * [types] [\#2776](https://github.com/onomyprotocol/onomy-sdk/issues/2776) Improve safety of `Coin` and `Coins` types. Various functions
 and methods will panic when a negative amount is discovered.
 * [\#2815](https://github.com/onomyprotocol/onomy-sdk/issues/2815) Gas unit fields changed from `int64` to `uint64`.
 * [\#2821](https://github.com/onomyprotocol/onomy-sdk/issues/2821) Codespaces are now strings
 * [\#2779](https://github.com/onomyprotocol/onomy-sdk/issues/2779) Introduce `ValidateBasic` to the `Tx` interface and call it in the ante
 handler.
 * [\#2825](https://github.com/onomyprotocol/onomy-sdk/issues/2825) More staking and distribution invariants
 * [\#2912](https://github.com/onomyprotocol/onomy-sdk/issues/2912) Print commit ID in hex when commit is synced.

* Tendermint
 * [\#2796](https://github.com/onomyprotocol/onomy-sdk/issues/2796) Update to go-amino 0.14.1
...
* SDK
  * [\#2733](https://github.com/onomyprotocol/onomy-sdk/issues/2733) [x/gov, x/mock/simulation] Fix governance simulation, update x/gov import/export
  * [\#2854](https://github.com/onomyprotocol/onomy-sdk/issues/2854) [x/bank] Remove unused bank.MsgIssue, prevent possible panic
  * [\#2884](https://github.com/onomyprotocol/onomy-sdk/issues/2884) [docs/examples] Fix `basecli version` panic
...
* SDK
  * [\#1336](https://github.com/onomyprotocol/onomy-sdk/issues/1336) Mechanism for SDK Users to configure their own Bech32 prefixes instead of using the default cosmos prefixes.
...
* SDK
 * [\#2573](https://github.com/onomyprotocol/onomy-sdk/issues/2573) [x/distribution] add accum invariance
 * [\#2556](https://github.com/onomyprotocol/onomy-sdk/issues/2556) [x/mock/simulation] Fix debugging output
 * [\#2396](https://github.com/onomyprotocol/onomy-sdk/issues/2396) [x/mock/simulation] Change parameters to get more slashes
 * [\#2617](https://github.com/onomyprotocol/onomy-sdk/issues/2617) [x/mock/simulation] Randomize all genesis parameters
 * [\#2669](https://github.com/onomyprotocol/onomy-sdk/issues/2669) [x/stake] Added invarant check to make sure validator's power aligns with its spot in the power store.
 * [\#1924](https://github.com/onomyprotocol/onomy-sdk/issues/1924) [x/mock/simulation] Use a transition matrix for block size
 * [\#2660](https://github.com/onomyprotocol/onomy-sdk/issues/2660) [x/mock/simulation] Staking transactions get tested far more frequently
 * [\#2610](https://github.com/onomyprotocol/onomy-sdk/issues/2610) [x/stake] Block redelegation to and from the same validator
 * [\#2652](https://github.com/onomyprotocol/onomy-sdk/issues/2652) [x/auth] Add benchmark for get and set account
 * [\#2685](https://github.com/onomyprotocol/onomy-sdk/issues/2685) [store] Add general merkle absence proof (also for empty substores)
 * [\#2708](https://github.com/onomyprotocol/onomy-sdk/issues/2708) [store] Disallow setting nil values
...
* Gaia
    ...
    * [x/stake, x/slashing] [#1305](https://github.com/onomyprotocol/onomy-sdk/issues/1305) - Rename "revoked" to "jailed"
    * [x/stake] [#1676] Revoked and jailed validators put into the unbonding state
    * [x/stake] [#1877] Redelegations/unbonding-delegation from unbonding validator have reduced time
    * [x/slashing] [\#1789](https://github.com/onomyprotocol/onomy-sdk/issues/1789) Slashing changes for Tendermint validator set offset (NextValSet)
    * [x/stake] [\#2040](https://github.com/onomyprotocol/onomy-sdk/issues/2040) Validator
    operator type has now changed to `sdk.ValAddress`
    * [x/stake] [\#2221](https://github.com/onomyprotocol/onomy-sdk/issues/2221) New
    ...
    * [x/stake] [\#2435](https://github.com/onomyprotocol/onomy-sdk/issues/2435) Remove empty bytes from the ValidatorPowerRank store key
    * [x/gov] [\#2195](https://github.com/onomyprotocol/onomy-sdk/issues/2195) Governance uses BFT Time
    * [x/gov] [\#2256](https://github.com/onomyprotocol/onomy-sdk/issues/2256) Removed slashing for governance non-voting validators
    * [simulation] [\#2162](https://github.com/onomyprotocol/onomy-sdk/issues/2162) Added back correct supply invariants
    * [x/slashing] [\#2430](https://github.com/onomyprotocol/onomy-sdk/issues/2430) Simulate more slashes, check if validator is jailed before jailing
...
* SDK
    ...
    * [core] [\#1807](https://github.com/onomyprotocol/onomy-sdk/issues/1807) Switch from use of rational to decimal
    * [types] [\#1901](https://github.com/onomyprotocol/onomy-sdk/issues/1901) Validator interface's GetOwner() renamed to GetOperator()
    * [x/slashing] [#2122](https://github.com/onomyprotocol/onomy-sdk/pull/2122) - Implement slashing period
    * [types] [\#2119](https://github.com/onomyprotocol/onomy-sdk/issues/2119) Parsed error messages and ABCI log errors to make     them more human readable.
    * [types] [\#2407](https://github.com/onomyprotocol/onomy-sdk/issues/2407) MulInt method added to big decimal in order to improve efficiency of slashing
    * [simulation] Rename TestAndRunTx to Operation [#2153](https://github.com/onomyprotocol/onomy-sdk/pull/2153)
    * [simulation] Remove log and testing.TB from Operation and Invariants, in favor of using errors [\#2282](https://github.com/onomyprotocol/onomy-sdk/issues/2282)
    * [simulation] Remove usage of keys and addrs in the types, in favor of simulation.Account [\#2384](https://github.com/onomyprotocol/onomy-sdk/issues/2384)
    * [tools] Removed gocyclo [#2211](https://github.com/onomyprotocol/onomy-sdk/issues/2211)
    * [baseapp] Remove `SetTxDecoder` in favor of requiring the decoder be set in baseapp initialization. [#1441](https://github.com/onomyprotocol/onomy-sdk/issues/1441)
    * [baseapp] [\#1921](https://github.com/onomyprotocol/onomy-sdk/issues/1921) Add minimumFees field to BaseApp.
    * [store] Change storeInfo within the root multistore to use tmhash instead of ripemd160 [\#2308](https://github.com/onomyprotocol/onomy-sdk/issues/2308)
    * [codec] [\#2324](https://github.com/onomyprotocol/onomy-sdk/issues/2324) All referrences to wire have been renamed to codec. Additionally, wire.NewCodec is now codec.New().
    * [types] [\#2343](https://github.com/onomyprotocol/onomy-sdk/issues/2343) Make sdk.Msg have a names field, to facilitate automatic tagging.
    * [baseapp] [\#2366](https://github.com/onomyprotocol/onomy-sdk/issues/2366) Automatically add action tags to all messages
    * [x/auth] [\#2377](https://github.com/onomyprotocol/onomy-sdk/issues/2377) auth.StdSignMsg -> txbuilder.StdSignMsg
    * [x/staking] [\#2244](https://github.com/onomyprotocol/onomy-sdk/issues/2244) staking now holds a consensus-address-index instead of a consensus-pubkey-index
    * [x/staking] [\#2236](https://github.com/onomyprotocol/onomy-sdk/issues/2236) more distribution hooks for distribution
    * [x/stake] [\#2394](https://github.com/onomyprotocol/onomy-sdk/issues/2394) Split up UpdateValidator into distinct state transitions applied only in EndBlock
    * [x/slashing] [\#2480](https://github.com/onomyprotocol/onomy-sdk/issues/2480) Fix signing info handling bugs & faulty slashing
    * [x/stake] [\#2412](https://github.com/onomyprotocol/onomy-sdk/issues/2412) Added an unbonding validator queue to EndBlock to automatically update validator.Status when finished Unbonding
    * [x/stake] [\#2500](https://github.com/onomyprotocol/onomy-sdk/issues/2500) Block conflicting redelegations until we add an index
    * [x/params] Global Paramstore refactored
    * [types] [\#2506](https://github.com/onomyprotocol/onomy-sdk/issues/2506) sdk.Dec MarshalJSON now marshals as a normal Decimal, with 10 digits of decimal precision
    * [x/stake] [\#2508](https://github.com/onomyprotocol/onomy-sdk/issues/2508) Utilize Tendermint power for validator power key
    * [x/stake] [\#2531](https://github.com/onomyprotocol/onomy-sdk/issues/2531) Remove all inflation logic
    * [x/mint] [\#2531](https://github.com/onomyprotocol/onomy-sdk/issues/2531) Add minting module and inflation logic
    * [x/auth] [\#2540](https://github.com/onomyprotocol/onomy-sdk/issues/2540) Rename `AccountMapper` to `AccountKeeper`.
    * [types] [\#2456](https://github.com/onomyprotocol/onomy-sdk/issues/2456) Renamed msg.Name() and msg.Type() to msg.Type() and msg.Route() respectively
...
* Gaia CLI  (`gaiacli`)
  ...
  * [cli] [\#2047](https://github.com/onomyprotocol/onomy-sdk/issues/2047) The --gas-adjustment flag can be used to adjust the estimate obtained via the simulation triggered by --gas=simulate.
  * [cli] [\#2110](https://github.com/onomyprotocol/onomy-sdk/issues/2110) Add --dry-run flag to perform a simulation of a transaction without broadcasting it. The --gas flag is ignored as gas would be automatically estimated.
  * [cli] [\#2204](https://github.com/onomyprotocol/onomy-sdk/issues/2204) Support generating and broadcasting messages with multiple signatures via command line:
...
* Gaia
    ...
    * [x/stake] [\#2435](https://github.com/onomyprotocol/onomy-sdk/issues/2435) Improve memory efficiency of getting the various store keys
    * [genesis] [\#2229](https://github.com/onomyprotocol/onomy-sdk/issues/2229) Ensure that there are no duplicate accounts or validators in the genesis state.
    * [genesis] [\#2450](https://github.com/onomyprotocol/onomy-sdk/issues/2450) Validate staking genesis parameters.
    * Add SDK validation to `config.toml` (namely disabling `create_empty_blocks`) [\#1571](https://github.com/onomyprotocol/onomy-sdk/issues/1571)
    * [\#1941](https://github.com/onomyprotocol/onomy-sdk/issues/1941)(https://github.com/onomyprotocol/onomy-sdk/issues/1941) Version is now inferred via `git describe --tags`.
    * [x/distribution] [\#1671](https://github.com/onomyprotocol/onomy-sdk/issues/1671) add distribution types and tests

* SDK
    * [tools] Make get_vendor_deps deletes `.vendor-new` directories, in case scratch files are present.
    * [spec] Added simple piggy bank distribution spec
    * [cli] [\#1632](https://github.com/onomyprotocol/onomy-sdk/issues/1632) Add integration tests to ensure `basecoind init && basecoind` start sequences run successfully for both `democoin` and `basecoin` examples.
    * [store] Speedup IAVL iteration, and consequently everything that requires IAVL iteration. [#2143](https://github.com/onomyprotocol/onomy-sdk/issues/2143)
    * [store] [\#1952](https://github.com/onomyprotocol/onomy-sdk/issues/1952), [\#2281](https://github.com/onomyprotocol/onomy-sdk/issues/2281) Update IAVL dependency to v0.11.0
    * [simulation] Make timestamps randomized [#2153](https://github.com/onomyprotocol/onomy-sdk/pull/2153)
    * [simulation] Make logs not just pure strings, speeding it up by a large factor at greater block heights [\#2282](https://github.com/onomyprotocol/onomy-sdk/issues/2282)
    ...
    * [types/decimal] [\#2378](https://github.com/onomyprotocol/onomy-sdk/issues/2378) - Added truncate functionality to decimal
    * [client] [\#1184](https://github.com/onomyprotocol/onomy-sdk/issues/1184) Remove unused `client/tx/sign.go`.
    * [tools] [\#2464](https://github.com/onomyprotocol/onomy-sdk/issues/2464) Lock binary dependencies to a specific version
...
* SDK
    * [\#1988](https://github.com/onomyprotocol/onomy-sdk/issues/1988) Make us compile on OpenBSD (disable ledger) [#1988] (https://github.com/onomyprotocol/onomy-sdk/issues/1988)
    * [\#2105](https://github.com/onomyprotocol/onomy-sdk/issues/2105) Fix DB Iterator leak, which may leak a go routine.
    * [ledger] [\#2064](https://github.com/onomyprotocol/onomy-sdk/issues/2064) Fix inability to sign and send transactions via the LCD by
    loading a Ledger device at runtime.
    * [\#2158](https://github.com/onomyprotocol/onomy-sdk/issues/2158) Fix non-deterministic ordering of validator iteration when slashing in `gov EndBlocker`
    * [simulation] [\#1924](https://github.com/onomyprotocol/onomy-sdk/issues/1924) Make simulation stop on SIGTERM
    * [\#2388](https://github.com/onomyprotocol/onomy-sdk/issues/2388) Remove dependency on deprecated tendermint/tmlibs repository.
    * [\#2416](https://github.com/onomyprotocol/onomy-sdk/issues/2416) Refactored `InitializeTestLCD` to properly include proposing validator in genesis state.
...
* Gaia
  ...
  - [x/gov] [\#1781](https://github.com/onomyprotocol/onomy-sdk/issues/1781) Added tags sub-package, changed tags to use dash-case
  - [x/gov] [\#1688](https://github.com/onomyprotocol/onomy-sdk/issues/1688) Governance parameters are now stored in globalparams store
  - [x/gov] [\#1859](https://github.com/onomyprotocol/onomy-sdk/issues/1859) Slash validators who do not vote on a proposal
  - [x/gov] [\#1914](https://github.com/onomyprotocol/onomy-sdk/issues/1914) added TallyResult type that gets stored in Proposal after tallying is finished
...
* SDK
  ...
  - [client] [\#1551](https://github.com/onomyprotocol/onomy-sdk/issues/1551): Refactored `CoreContext` to `TxContext` and `QueryContext`
...
* Tendermint
    ...
    - v0.23.0 -> See
      ...
      and [SDK PR](https://github.com/onomyprotocol/onomy-sdk/pull/1927)
...
* SDK
  ...
  - [store] [\#1481](https://github.com/onomyprotocol/onomy-sdk/issues/1481) Add transient store
  - [baseapp] Initialize validator set on ResponseInitChain
  - [baseapp] added BaseApp.Seal - ability to seal baseapp parameters once they've been set
  - [onomy-sdk-cli] New `onomy-sdk-cli` tool to quickly initialize a new
    SDK-based project
...
* Gaia
  ...
  - [x/stake] [\#1815](https://github.com/onomyprotocol/onomy-sdk/issues/1815) Sped up the processing of `EditValidator` txs.
  - [config] [\#1930](https://github.com/onomyprotocol/onomy-sdk/issues/1930) Transactions indexer indexes all tags by default.
  - [ci] [#2057](https://github.com/onomyprotocol/onomy-sdk/pull/2057) Run `make localnet-start` on every commit and ensure network reaches at least 10 blocks

* SDK
  - [baseapp] [\#1587](https://github.com/onomyprotocol/onomy-sdk/issues/1587) Allow any alphanumeric character in route
  - [baseapp] Allow any alphanumeric character in route
  - [tools] Remove `rm -rf vendor/` from `make get_vendor_deps`
  - [x/auth] Recover ErrorOutOfGas panic in order to set sdk.Result attributes correctly
  - [x/auth] [\#2376](https://github.com/onomyprotocol/onomy-sdk/issues/2376) No longer runs any signature in a multi-msg, if any account/sequence number is wrong.
  - [x/auth] [\#2376](https://github.com/onomyprotocol/onomy-sdk/issues/2376) No longer charge gas for subtracting fees
  - [x/bank] Unit tests are now table-driven
  - [tests] Add tests to example apps in docs
  - [tests] Fixes ansible scripts to work with AWS too
  - [tests] [\#1806](https://github.com/onomyprotocol/onomy-sdk/issues/1806) CLI tests are now behind the build flag 'cli_test', so go test works on a new repo
...
* Gaia
  ...
  - [tests] [\#1551](https://github.com/onomyprotocol/onomy-sdk/issues/1551) Fixed invalid LCD test JSON payload in `doIBCTransfer`
  - [basecoin] Fixes coin transaction failure and account query [discussion](https://forum.cosmos.network/t/unmarshalbinarybare-expected-to-read-prefix-bytes-75fbfab8-since-it-is-registered-concrete-but-got-0a141dfa/664/6)
  - [x/gov] [\#1757](https://github.com/onomyprotocol/onomy-sdk/issues/1757) Fix VoteOption conversion to String
...
*  [\#1797](https://github.com/onomyprotocol/onomy-sdk/issues/1797) Fix off-by-one error in slashing for downtime
*  [\#1787](https://github.com/onomyprotocol/onomy-sdk/issues/1787) Fixed bug where Tally fails due to revoked/unbonding validator
*  [\#1666](https://github.com/onomyprotocol/onomy-sdk/issues/1666) Add intra-tx counter to the genesis validators
...
BUG FIXES
* [x/slashing] [\#1510](https://github.com/onomyprotocol/onomy-sdk/issues/1510) Unrevoked validators cannot un-revoke themselves
* [x/stake] [\#1513](https://github.com/onomyprotocol/onomy-sdk/issues/1513) Validators slashed to zero power are unbonded and removed from the store
* [x/stake] [\#1567](https://github.com/onomyprotocol/onomy-sdk/issues/1567) Validators decreased in power but not unbonded are now updated in Tendermint
...
* [\#872](https://github.com/onomyprotocol/onomy-sdk/issues/872)  - recovery phrases no longer all end in `abandon`
* [\#887](https://github.com/onomyprotocol/onomy-sdk/issues/887)  - limit the size of rationals that can be passed in from user input
* [\#1052](https://github.com/onomyprotocol/onomy-sdk/issues/1052) - Make all now works
* [\#1258](https://github.com/onomyprotocol/onomy-sdk/issues/1258) - printing big.rat's can no longer overflow int64
* [\#1259](https://github.com/onomyprotocol/onomy-sdk/issues/1259) - fix bug where certain tests that could have a nil pointer in defer
* [\#1343](https://github.com/onomyprotocol/onomy-sdk/issues/1343) - fixed unnecessary parallelism in CI
...
* [\#1010](https://github.com/onomyprotocol/onomy-sdk/issues/1010) - two validators can't bond with the same pubkey anymore
...
FIXES
* Fixes consensus fault on testnet - see postmortem [here](https://github.com/onomyprotocol/onomy-sdk/issues/1197#issuecomment-396823021)
...
[Unreleased]: https://github.com/onomyprotocol/onomy-sdk/compare/v0.38.2...HEAD
[v0.38.2]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.38.2
[v0.38.1]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.38.1
[v0.38.0]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.38.0
[v0.37.9]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.9
[v0.37.8]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.8
[v0.37.7]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.7
[v0.37.6]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.6
[v0.37.5]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.5
[v0.37.4]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.4
[v0.37.3]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.3
[v0.37.1]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.1
[v0.37.0]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.37.0
[v0.36.0]: https://github.com/onomyprotocol/onomy-sdk/releases/tag/v0.36.0
