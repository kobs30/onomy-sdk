...
The list of all available gRPC query endpoints is [coming soon](https://github.com/onomyprotocol/onomy-sdk/issues/7786).
...
You can replace the query client (here we are using `x/bank`'s) with one generated from any other Protobuf service. The list of all available gRPC query endpoints is [coming soon](https://github.com/onomyprotocol/onomy-sdk/issues/7786).
