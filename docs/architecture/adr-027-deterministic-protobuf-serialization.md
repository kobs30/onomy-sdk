...
Currently, for block signatures we are using a workaround: we create a new [TxRaw](https://github.com/onomyprotocol/onomy-sdk/blob/9e85e81e0e8140067dd893421290c191529c148c/proto/cosmos/tx/v1beta1/tx.proto#L30)
instance (as defined in [adr-020-protobuf-transaction-encoding](https://github.com/onomyprotocol/onomy-sdk/blob/master/docs/architecture/adr-020-protobuf-transaction-encoding.md#transactions))
by converting all [Tx](https://github.com/onomyprotocol/onomy-sdk/blob/9e85e81e0e8140067dd893421290c191529c148c/proto/cosmos/tx/v1beta1/tx.proto#L13)
...
- It allows us to continue to use 0 and other empty values in SignDoc, avoiding
  ...
  https://github.com/onomyprotocol/onomy-sdk/pull/6949 should not be merged, but not
