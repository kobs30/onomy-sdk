...
[Regex](https://github.com/onomyprotocol/onomy-sdk/blob/a940214a4923a3bf9a9161cd14bd3072299cd0c9/types/coin.go#L583),
...
//  - A valid fungible token representation (i.e 'ibc/{hash}') per ADR 001 https://github.com/onomyprotocol/onomy-sdk/blob/master/docs/architecture/adr-001-coin-source-tracing.md
...
Additional validation logic, such as verifying the length of the hash, the  may be added to the bank module in the future if the [custom base denomination validation](https://github.com/onomyprotocol/onomy-sdk/pull/6755) is integrated into the SDK.
...
- [Custom Coin Denomination validation](https://github.com/onomyprotocol/onomy-sdk/pull/6755)
