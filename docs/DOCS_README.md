...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/onomyprotocol/onomy-sdk/tree/master/CONTRIBUTING.md#updating-documentation)
...
[master](https://github.com/onomyprotocol/onomy-sdk/tree/master/docs).
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/onomyprotocol/onomy-sdk/blob/master/client/lcd/swagger-ui/swagger.yaml)

Finally, run `make update_ochain_lite_docs` from the root of the repo.
