...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc4/types/tx_msg.go#L83-L87

A standard implementation of both these objects can be found in the [`auth` module](../../x/auth/spec/README.md):

+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc4/x/auth/tx/decoder.go

+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc4/x/auth/tx/encoder.go
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.42.1/x/auth/types/account.go#L307-L330
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.42.1/x/staking/types/validator.go#L40-L61
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc4/codec/types/interface_registry.go#L25-L66
