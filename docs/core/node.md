...
- Then, the `config` is retrieved and config parameters are set. This mainly involves setting the Bech32 prefixes for [addresses](../basics/accounts.md#addresses).
  +++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc3/types/config.go#L13-L24
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc3/simapp/simd/main.go
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc3/server/start.go#L227-L228
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc3/simapp/simd/cmd/root.go#L170-L215

Then, the instance of `app` is used to instanciate a new Tendermint node:

+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc3/server/start.go#L235-L244
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc3/server/start.go#L250-L252
