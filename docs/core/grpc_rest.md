...
<https://github.com/onomyprotocol/onomy-sdk/blob/v0.41.0/server/types/app.go#L39-L41>
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.41.0/proto/cosmos/bank/v1beta1/query.proto#L19-L22
...
For application developers, you may want to generate your own Swagger definitions based on your custom modules. The SDK's [Swagger generation script](https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0-rc4/scripts/protoc-swagger-gen.sh) is a good place to start.
