...
```bash
go test -v --bench github.com/onomyprotocol/onomy-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/onomyprotocol/onomy-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/onomyprotocol/onomy-sdk/crypto/keys/mintkey	12.093s
```
