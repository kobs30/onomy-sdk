...
Builds:
- onomy-sdk simapp node, with prefixed data directory, keys etc. This is required to test historical balances.
...
- rosetta is the rosetta node used by rosetta-cli to interact with the onomy-sdk app
