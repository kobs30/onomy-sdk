...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/onomyprotocol/onomy-sdk/types/errors.Wrap",
		"github.com/onomyprotocol/onomy-sdk/types/errors.Wrapf",
		"github.com/onomyprotocol/onomy-sdk/types/errors.WithType",
