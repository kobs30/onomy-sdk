...
- [ ] API audit (at least 1 person) (@assignee)
  ...
  - [ ] Is everything well documented (inline godoc as well as [`/spec/` folder](https://github.com/onomyprotocol/onomy-sdk/blob/master/docs/spec/SPEC-SPEC.md) in module directory)
