...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"onomy-sdk/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"stake"}],"depositor":"cosmos1v9jxgu33kfsgr5","proposal_id":"0"}}`
...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	require.Equal(t,
		`{"type":"onomy-sdk/MsgSubmitProposal","value":{"content":{"type":"onomy-sdk/TextProposal","value":{"description":"abcd","title":"test"}},"initial_deposit":[]}}`,
		string(bz))
}
