...
power included in the `LastCommitInfo` and +2/3 (see [fee distribution](https://github.com/onomyprotocol/onomy-sdk/blob/master/docs/spec/fee_distribution)).
...
+++ https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0/proto/cosmos/slashing/v1beta1/slashing.proto#L11-L33
