...
This document specifies the feegrant module. For the full ADR, please see [Fee Grant ADR-029](https://github.com/onomyprotocol/onomy-sdk/blob/v0.40.0/docs/architecture/adr-029-fee-grant-module.md).
