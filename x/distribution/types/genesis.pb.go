...
type ValidatorOutstandingRewardsRecord struct {
	...
	OutstandingRewards github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=outstanding_rewards,json=outstandingRewards,proto3,castrepeated=github.com/onomyprotocol/onomy-sdk/types.DecCoins" json:"outstanding_rewards" yaml:"outstanding_rewards"`
}
