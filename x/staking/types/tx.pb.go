...
type MsgCreateValidator struct {
	...
	MinSelfDelegation github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/onomyprotocol/onomy-sdk/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
...
type MsgEditValidator struct {
	...
	// REF: #2373
	CommissionRate    *github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/onomyprotocol/onomy-sdk/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/onomyprotocol/onomy-sdk/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
