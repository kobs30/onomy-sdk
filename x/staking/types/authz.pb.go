...
type StakeAuthorization struct {
	...
	MaxTokens *types.Coin `protobuf:"bytes,1,opt,name=max_tokens,json=maxTokens,proto3,castrepeated=github.com/onomyprotocol/onomy-sdk/types.Coin" json:"max_tokens,omitempty"`
